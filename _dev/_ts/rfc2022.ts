...
import Mv from './components/rfc2022/Mv';
import Map from './components/rfc2022/Map';


namespace Main {
	export class rfc2022 extends Base.PageCore {
		// private $body = $('body');
...
document.addEventListener('DOMContentLoaded', () => {
	...
	Model.data.rootApp = new Main.rfc2022();
}, false);
