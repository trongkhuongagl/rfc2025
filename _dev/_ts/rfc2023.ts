...
import Mv from './components/rfc2023/Mv';
import Map from './components/rfc2023/Map';


namespace Main {
	export class rfc2023 extends Base.PageCore {
		// private $body = $('body');
...
document.addEventListener('DOMContentLoaded', () => {
	...
	Model.data.rootApp = new Main.rfc2023();
}, false);
