...
import Mv from './components/rfc2024/Mv';
import Map from './components/rfc2024/Map';


namespace Main {
	export class rfc2024 extends Base.PageCore {
		// private $body = $('body');
...
document.addEventListener('DOMContentLoaded', () => {
	...
	Model.data.rootApp = new Main.rfc2024();
}, false);
